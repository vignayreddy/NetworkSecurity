...
class DataTransformation:
    ...
    def get_transformer_object(cls)->Pipeline:
        ...
        try:
            ...
            logging.info(f"Initialize KNIMputer with {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered initiate_data_transformation method if DataTransformation class")
        try:
